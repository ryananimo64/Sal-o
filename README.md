...
CREATE TABLE Pagamentos (
    ...
    FOREIGN KEY (agendamento) REFERENCES Agendamentos(id_agendamento)
);
...
INSERT INTO Agendamentos (cliente, funcionario, servico, data_hora, status) VALUES
...
INSERT INTO Pagamentos (agendamento, valor, metodo_pagamento) VALUES
(1, 50.00, 'Dinheiro'),
(2, 40.00, 'Cartão'),
(3, 120.00, 'Pix'),
(4, 50.00, 'Dinheiro'),
